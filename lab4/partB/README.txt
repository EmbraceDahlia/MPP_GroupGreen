Create a sequence diagram based on the flow that occurs when an actor
invokes the checkoutBook() method on CheckoutForm
...
theILibraryDBSubsystem.addCheckoutRecord(member.getMemberID(),aChe
ckoutRecord);
